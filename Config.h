...
#include <Wire.h>
#include "Hardware/Sensors/Accelerometer/Accelerometer.h"
#include "Hardware/Sensors/Accelerometer/AccelerometerConfig.h"
#include "Hardware/Sensors/Barometer/Barometer.h"
#include "Hardware/Sensors/Barometer/BarometerConfig.h"
...
#ifdef USE_ADXL343
    #include "Hardware/Sensors/Accelerometer/ADXL343_Accelerometer.h"
    AccelerometerConfig accelConfig = {123, &Wire1};
    Accelerometer* accelerometer = new ADXL343_Accelerometer(accelConfig);
#endif

#ifdef USE_MS5637
    #include "Hardware/Sensors/Barometer/MS5637_Barometer.h"
